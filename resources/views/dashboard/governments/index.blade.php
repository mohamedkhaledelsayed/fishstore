            ...
            <div class="col-lg-9 col-md-8 col-xs-12 align-self-center">
                <nav aria-label="breadcrumb" class="mt-2 float-md-right float-left">
                    <ol class="breadcrumb mb-0 justify-content-end p-0 bg-white">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"> @lang('admin.governments')</li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header border">
                        <h3 class="d-inline">@lang('admin.governments')</h3>
                        <a href="{{route('governments.create')}}" class="btn btn-primary">@lang('admin.add') <i
