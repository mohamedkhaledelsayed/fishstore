                ...
                <nav aria-label="breadcrumb" class="mt-2 float-md-right float-left">
                    <ol class="breadcrumb mb-0 justify-content-end p-0 bg-white">
                        ...
                        <li class="breadcrumb-item active"
                            aria-current="page"> @lang('admin.add') @lang('admin.government')</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-body">
                    <div class="card card-body">
                        <h4 class="card-title">@lang('admin.add') @lang('admin.government')</h4>
                        @include('dashboard.layouts.messages')
                        <div class="row">
                            <div class="col-sm-12 col-xs-12">
                                <form action="{{route('governments.store')}}" method="post">
                                    @csrf
                                    <input type="hidden" name="short_name" id="short_name" value="{{old('short_name')}}">
...
@push('js')
    ...
    <script>
        $('#map').locationpicker({
            location :
                {
                    latitude : '{{old('lat',29.31166)}}',
                    longitude : '{{old('lon',47.481766)}}',
                },
            zoom : 8,
            inputBinding: {
