            ...
            <div class="col-lg-9 col-md-8 col-xs-12 align-self-center">
                <nav aria-label="breadcrumb" class="mt-2 float-md-right float-left">
                    <ol class="breadcrumb mb-0 justify-content-end p-0 bg-white">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"> @lang('admin.customers')</li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header border">
                        <h3 class="d-inline">@lang('admin.customers')</h3>
                        <a href="{{route('users.create')}}" class="btn btn-primary">@lang('admin.add') <i
                        ...
                        <div class="table-responsive">
                            <table id="table_export" class="table table-striped table-bordered" style="width:100%">
                                ...
                                <tr>
                                    ...
                                    <th scope="col" class="border search-sorting" data-sort-name="id"
                                        data-sort-type="active">
                                        @lang('admin.activated')
                                        <img class="sort-type-image" src="{{asset('admin/image/sort_both.png')}}"
                                             alt="">
                                        <span class="sort-type-icon fa fa-sort-up d-none"></span>
                                    </th>
